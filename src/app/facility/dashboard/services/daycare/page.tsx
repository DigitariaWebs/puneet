...
export default function DaycareServicePage() {
  ...
  const [settings, setSettings] = useState({
    ...
    description:
      "Full day daycare service with playtime, feeding, and supervision.",
    rules: "Pets must be up to date on vaccinations. No aggressive breeds.",
    sessions: [
      {
        id: "1",
        date: "2024-01-15",
  ...
  return (
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold tracking-tight">Daycare Service</h2>
          <p className="text-muted-foreground">
            Manage your daycare service settings and pricing
          </p>
        </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              <Label htmlFor="enabled">Enable Daycare Service</Label>
              <Switch
                id="enabled"
            ...
            <p className="text-sm text-muted-foreground">
              When enabled, customers can book daycare services for their pets.
            </p>
          </CardContent>
        </Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input
                id="price"
                type="number"
                value={currentSettings.pricePerDay}
                onChange={(e) =>
                  setTempSettings({
                    ...tempSettings,
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <p className="text-sm text-muted-foreground">
            Select the locations where this daycare service is available.
          </p>
        </CardContent>
      </Card>
